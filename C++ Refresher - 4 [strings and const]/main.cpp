/*--------------------------------------------------------------------------+
|	This code sample is about string manipulation in C++, and also the		|
|	const modifier.
|																			|
...
int main(int argc, const char * argv[]) 
{
	...
	// for primitive data types (int char, etc.) const is kinda the same as final in Java
	const int x = 20;
	//x += 3;
